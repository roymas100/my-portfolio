...
export default async function Home ({
  ...
  return (
    <main className='flex min-h-screen flex-col xl:items-center justify-between'>
      ...
      <div className='grid z-10 area-one-flow md:area-slim xl:area-wide border-collapse xl:max-w-[1280px] gap-0'>
        ...
        <div className='left1 border-t border-b border-border' />
        ...
        <div className='left6 border-t border-b border-border' />
        <div className='right1 border-t border-b border-border' />
        ...
        <div className='right6 border-t border-b border-border' />
