...
export const about_me = {
    part_1: 'Olá Mundo! Eu sou um ',
    fullstack: 'desenvolvedor Fullstack',
    computer_science: 'Ciência da Computação',
    part_2: 'com foco em desenvolvimento móvel. Também sou graduado em',
    part_3: 'Estou inspirado para criar novos aplicativos e testar novas tecnologias.'
}
